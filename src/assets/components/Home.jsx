      ...
      <main className="flex-grow bg-gray-100 py-10 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-6 mt-8">
            ...
            <a href="" target="_blank" rel="noopener noreferrer" className="bg-yellow-400 hover:bg-yellow-500 text-black py-4 rounded-lg shadow text-lg font-semibold transition">
              Electrical
            </a>
            <a href="" target="_blank" rel="noopener noreferrer" className="bg-teal-400 hover:bg-teal-500 text-white py-4 rounded-lg shadow text-lg font-semibold transition">
            
              <Link to="/Archform" className="text-red-600 hover:underline">
               Architecture
              </Link>
            </a>
          </div>
